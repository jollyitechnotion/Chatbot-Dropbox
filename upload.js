...
const MICROSOFT_APP_ID = "f0807a72-4ed2-4e51-bab8-4a99015bac10";
const MICROSOFT_APP_PASSWORD = "HpMeHu3NZV9M]6{+";
...
function getSourceToken(callback) {
    restify.createStringClient({
        ...
        client_id : "f0807a72-4ed2-4e51-bab8-4a99015bac10",
        client_secret : "HpMeHu3NZV9M]6{+"
